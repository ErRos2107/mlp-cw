...
python twitter_starter.py --batch_size 256 --epochs 50 --pt_embedding True --dropout_rate 0.5 --experiment_prefix TwitterStd1 --tensorboard_use True --seed 16122017