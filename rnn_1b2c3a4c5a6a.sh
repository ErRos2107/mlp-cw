...
python twitter_starter.py --typec rnn --experiment_prefix 1b2c3a4c5a6a --seed 25012018 --cell lstm --hidden_unit 128 --dropout_rate 0 --num_units 1024 --batch_size 128 --epochs 50
