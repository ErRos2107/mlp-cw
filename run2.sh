...
python twitter_starter.py --experiment_prefix 1 --batch_size 256 --epochs 50 --pt_embedding True --dropout_rate_value 0.5 --experiment_prefix TwitterStd --tensorboard_use True --seed 16122017

python twitter_starter.py --experiment_prefix 2 --batch_size 256 --epochs 50 --pt_embedding True --dropout_rate_value 0.3 --experiment_prefix TwitterStd --tensorboard_use True --seed 16122017
