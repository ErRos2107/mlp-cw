...
python twitter_starter.py --batch_size 256 --epochs 50 --pt_embedding True --dropout_rate 0.0 --experiment_prefix TwitterStd3 --tensorboard_use True --seed 16122017
